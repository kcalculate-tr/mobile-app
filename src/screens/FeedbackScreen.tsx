...
const s = StyleSheet.create({
  ...
  cardTitle: { fontSize: TYPOGRAPHY.size.md, fontFamily: 'PlusJakartaSans_700Bold', color: COLORS.text.primary, marginBottom: SPACING.md },
  ...
  catChipText: { fontSize: TYPOGRAPHY.size.sm, fontFamily: 'PlusJakartaSans_600SemiBold', color: SURFACE.unselectedText },
  catChipTextActive: { color: COLORS.text.primary, fontFamily: 'PlusJakartaSans_700Bold'},
  starRow: { flexDirection: 'row', gap: SPACING.sm, justifyContent: 'center', paddingVertical: SPACING.sm },
  ratingLabel: { textAlign: 'center', fontSize: TYPOGRAPHY.size.md, fontFamily: 'PlusJakartaSans_700Bold', color: '#F59E0B', marginTop: SPACING.xs },
  textarea: {
  ...
  submitBtnText: { fontSize: TYPOGRAPHY.size.md, fontFamily: 'PlusJakartaSans_800ExtraBold', color: COLORS.text.primary },
  successBox: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: SPACING['3xl'], gap: SPACING.lg },
  successTitle: { fontSize: TYPOGRAPHY.size['3xl'], fontFamily: 'PlusJakartaSans_800ExtraBold', color: COLORS.text.primary },
  ...
  backHomeBtnText: { fontSize: TYPOGRAPHY.size.md, fontFamily: 'PlusJakartaSans_800ExtraBold', color: COLORS.text.primary },
})
