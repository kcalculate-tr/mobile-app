...
const s = StyleSheet.create({
  ...
  retryBtnText: { color: COLORS.text.primary, fontFamily: 'PlusJakartaSans_700Bold', fontSize: TYPOGRAPHY.size.md },
  ...
  orderCode: { fontSize: TYPOGRAPHY.size.xl, fontFamily: 'PlusJakartaSans_700Bold', color: COLORS.text.primary },
  statusBadge: { borderRadius: 100, paddingHorizontal: 12, paddingVertical: 5 },
  statusBadgeText: { fontSize: TYPOGRAPHY.size.sm, fontFamily: 'PlusJakartaSans_700Bold'},
  ...
  stepTitle: { fontSize: TYPOGRAPHY.size.md, fontFamily: 'PlusJakartaSans_600SemiBold', color: COLORS.text.tertiary, marginBottom: 2 },
  stepTitleDone: { color: COLORS.text.primary },
  stepSub: { fontSize: TYPOGRAPHY.size.sm, color: COLORS.text.tertiary },

  // Items
  sectionTitle: { fontSize: TYPOGRAPHY.size.md, fontFamily: 'PlusJakartaSans_700Bold', color: COLORS.text.primary },
  ...
  itemName: { fontSize: TYPOGRAPHY.size.md, fontFamily: 'PlusJakartaSans_600SemiBold', color: COLORS.text.primary },
  itemQty: { fontSize: TYPOGRAPHY.size.sm, color: COLORS.text.tertiary, marginTop: 2 },
  itemTotal: { fontSize: TYPOGRAPHY.size.md, fontFamily: 'PlusJakartaSans_700Bold', color: COLORS.text.primary },

  // Info rows
  infoRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 4 },
  infoLabel: { fontSize: TYPOGRAPHY.size.sm, color: COLORS.text.tertiary },
  infoValue: { fontSize: TYPOGRAPHY.size.sm, fontFamily: 'PlusJakartaSans_600SemiBold', color: COLORS.text.primary },
  totalRow: { borderTopWidth: 1, borderTopColor: 'rgba(0,0,0,0.06)', paddingTop: 10, marginTop: 4 },
  totalLabel: { fontSize: TYPOGRAPHY.size.lg, fontFamily: 'PlusJakartaSans_700Bold', color: COLORS.text.primary },
  totalAmount: { fontSize: TYPOGRAPHY.size['2xl'], fontFamily: 'PlusJakartaSans_800ExtraBold', color: COLORS.text.primary },
  ...
  footerBtnText: { fontSize: TYPOGRAPHY.size.md, fontFamily: 'PlusJakartaSans_700Bold', color: COLORS.text.primary },
