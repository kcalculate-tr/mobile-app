...
const s = StyleSheet.create({
  ...
  mockCardLabel: { fontSize: 16, fontFamily: 'PlusJakartaSans_700Bold', color: 'rgba(255,255,255,0.6)' },
  mockCardSub: { fontSize: 12, color: 'rgba(255,255,255,0.35)', marginBottom: 12 },

  emptyTitle: { fontSize: 16, fontFamily: 'PlusJakartaSans_700Bold', color: '#000000', textAlign: 'center' },
  ...
  cardTitle: { fontSize: 14, fontFamily: 'PlusJakartaSans_700Bold', color: '#000000' },
  ...
  defaultBadgeText: { fontSize: 11, fontFamily: 'PlusJakartaSans_700Bold', color: '#1a3d00' },
  actionBtn: {
    borderRadius: 100, paddingHorizontal: 10, paddingVertical: 6,
    backgroundColor: '#f0f0f0',
  },
  actionBtnText: { fontSize: 11, fontFamily: 'PlusJakartaSans_600SemiBold', color: COLORS.text.secondary },
  deleteBtn: {
  ...
  addBtnText: { fontSize: 15, fontFamily: 'PlusJakartaSans_700Bold', color: '#1a3d00' },
  ...
  trustTitle: { fontSize: 14, fontFamily: 'PlusJakartaSans_700Bold', color: '#000000' },
