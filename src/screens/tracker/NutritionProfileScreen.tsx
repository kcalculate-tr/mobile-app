...
const tg = StyleSheet.create({
  ...
  text: { fontSize: 13, fontFamily: 'PlusJakartaSans_600SemiBold', color: SURFACE.unselectedText },
...
const s = StyleSheet.create({
  ...
  cardLabel: { fontSize: 13, fontFamily: 'PlusJakartaSans_700Bold', color: '#000000' },
  optionalTag: { fontSize: 11, fontFamily: 'PlusJakartaSans_400Regular', color: COLORS.text.tertiary },

  // BMI
  bmiCategoryBadge: { borderRadius: 100, paddingHorizontal: 10, paddingVertical: 4 },
  bmiCategoryText: { fontSize: 11, fontFamily: 'PlusJakartaSans_700Bold'},
  bmiValue: { fontSize: 36, fontFamily: 'PlusJakartaSans_800ExtraBold'},
  ...
  inputLabel: { fontSize: 11, color: COLORS.text.secondary, fontFamily: 'PlusJakartaSans_600SemiBold'},
  numInput: {
    height: 48, borderRadius: 12, borderWidth: 1,
    borderColor: SURFACE.inputBorder, backgroundColor: SURFACE.inputBg,
    paddingHorizontal: 10, fontSize: 18, fontFamily: 'PlusJakartaSans_700Bold',
  ...
  activityLabel: { fontSize: 14, fontFamily: 'PlusJakartaSans_600SemiBold', color: '#000000' },
  ...
  macroToggleBtnText: { fontSize: 12, fontFamily: 'PlusJakartaSans_600SemiBold', color: SURFACE.unselectedText },
...
fontFamily: 'PlusJakartaSans_700Bold' },
  ...
  successText: { fontSize: 13, color: '#16A34A', textAlign: 'center', fontFamily: 'PlusJakartaSans_600SemiBold'},
  saveBtn: {
    height: 56, borderRadius: 100, backgroundColor: COLORS.brand.green,
    alignItems: 'center', justifyContent: 'center',
  },
  saveBtnDisabled: { opacity: 0.7 },
  saveBtnText: { fontSize: 16, fontFamily: 'PlusJakartaSans_700Bold', color: '#000000' },
});
