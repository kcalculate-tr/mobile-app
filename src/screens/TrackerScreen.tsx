...
const s = StyleSheet.create({
  ...
  headerTitle: { fontSize: TYPOGRAPHY.size['3xl'], fontFamily: 'PlusJakartaSans_800ExtraBold', color: '#000000' },
  ...
  toggleBtnText: { fontSize: TYPOGRAPHY.size.sm, fontFamily: 'PlusJakartaSans_600SemiBold', color: '#000000' },
  ...
  dateRangeBtnLabel: { fontSize: TYPOGRAPHY.size.xs, fontFamily: 'PlusJakartaSans_600SemiBold', color: COLORS.text.tertiary, textTransform: 'uppercase' },
  dateRangeBtnValue: { fontSize: TYPOGRAPHY.size.sm, fontFamily: 'PlusJakartaSans_700Bold', color: '#000', marginTop: 2 },
  dateRangeSep: { fontSize: TYPOGRAPHY.size.lg, color: COLORS.text.tertiary, fontFamily: 'PlusJakartaSans_400Regular'},
  dateRangeApply: {
    backgroundColor: COLORS.brand.green, borderRadius: RADIUS.sm,
    paddingHorizontal: SPACING.md, paddingVertical: SPACING.sm,
  },
  dateRangeApplyText: { fontSize: TYPOGRAPHY.size.sm, fontFamily: 'PlusJakartaSans_800ExtraBold', color: '#000' },
  ...
  filterText: { fontSize: TYPOGRAPHY.size.sm, fontFamily: 'PlusJakartaSans_500Medium', color: 'rgba(0,0,0,0.5)' },
  filterTextActive: { color: '#000000', fontFamily: 'PlusJakartaSans_700Bold', opacity: 1 },
  ...
  retryBtnText: { color: '#000000', fontFamily: 'PlusJakartaSans_700Bold', fontSize: TYPOGRAPHY.size.md },
  ...
  ringKcal: { fontSize: TYPOGRAPHY.size['6xl'], fontFamily: 'PlusJakartaSans_800ExtraBold', color: '#000000', lineHeight: 40 },
  ...
  ringBadgeText: { fontSize: TYPOGRAPHY.size.xs, fontFamily: 'PlusJakartaSans_700Bold', color: '#000000' },
  ringTargetLabel: { fontSize: TYPOGRAPHY.size.sm, color: COLORS.text.tertiary, marginTop: SPACING.sm, textAlign: 'center' },
  ringTargetBold: { color: '#000000', fontFamily: 'PlusJakartaSans_700Bold'},
  // Mini stats
  ...
  miniStatValue: { fontSize: TYPOGRAPHY.size.lg, fontFamily: 'PlusJakartaSans_800ExtraBold', color: '#000000', marginBottom: 2 },
  ...
  sectionTitle: { fontSize: TYPOGRAPHY.size.md, fontFamily: 'PlusJakartaSans_700Bold', color: '#000000' },
  ...
  macroRingValue: { fontSize: TYPOGRAPHY.size.md, fontFamily: 'PlusJakartaSans_800ExtraBold', color: '#000000' },
  macroRingInfo: { alignItems: 'center', width: '100%' },
  macroRingLabel: { fontSize: TYPOGRAPHY.size.xs, fontFamily: 'PlusJakartaSans_700Bold', color: '#000000', marginBottom: 2 },
  ...
  waterTitleRow: { gap: 2 },
  waterTitle: { fontSize: TYPOGRAPHY.size.sm, fontFamily: 'PlusJakartaSans_700Bold', color: '#000000' },
  ...
  pdfBtnText: { fontSize: TYPOGRAPHY.size.sm, fontFamily: 'PlusJakartaSans_700Bold', color: COLORS.brand.green },
  ...
  diffBadgeText: { fontSize: TYPOGRAPHY.size.xs, fontFamily: 'PlusJakartaSans_700Bold'},
  barTargetLine: {
  ...
  scoreValue: { fontSize: TYPOGRAPHY.size['2xl'], fontFamily: 'PlusJakartaSans_800ExtraBold'},
  ...
  macroConsistencyDays: { fontSize: TYPOGRAPHY.size.xs, fontFamily: 'PlusJakartaSans_700Bold', color: '#000', width: 20, textAlign: 'right' },
  ...
  macroDagPct: { fontSize: TYPOGRAPHY.size.lg, fontFamily: 'PlusJakartaSans_800ExtraBold'},
  macroDagLabel: { fontSize: TYPOGRAPHY.size.xs, color: COLORS.text.tertiary },
  macroDagG: { fontSize: TYPOGRAPHY.size.sm, fontFamily: 'PlusJakartaSans_700Bold', color: '#000' },
  ...
  weightSummaryValue: { fontSize: TYPOGRAPHY.size.md, fontFamily: 'PlusJakartaSans_700Bold', color: '#000' },
  weightSumCell: { flex: 1, alignItems: 'center', gap: 3 },
  weightSumLabel: { fontSize: TYPOGRAPHY.size.xs, color: COLORS.text.tertiary },
  weightSumValue: { fontSize: TYPOGRAPHY.size.md, fontFamily: 'PlusJakartaSans_800ExtraBold', color: '#000000' },
  weightChangeBadge: { borderRadius: RADIUS.pill, paddingHorizontal: SPACING.md, paddingVertical: SPACING.xs },
  weightChangeText: { fontSize: TYPOGRAPHY.size.sm, fontFamily: 'PlusJakartaSans_800ExtraBold'},
  ...
  bedenLabel: { fontSize: TYPOGRAPHY.size.xs, color: COLORS.text.tertiary, fontFamily: 'PlusJakartaSans_600SemiBold'},
  bedenValue: { fontSize: TYPOGRAPHY.size.lg, fontFamily: 'PlusJakartaSans_800ExtraBold', color: '#000' },
  bedenDiff: { borderRadius: RADIUS.pill, paddingHorizontal: SPACING.sm, paddingVertical: 3 },
  bedenDiffText: { fontSize: TYPOGRAPHY.size.xs, fontFamily: 'PlusJakartaSans_700Bold'},
  ...
  pdfBottomBtnText: { fontSize: TYPOGRAPHY.size.md, fontFamily: 'PlusJakartaSans_800ExtraBold', color: COLORS.brand.green },
  grafikCard: {
    backgroundColor: '#ffffff',
    borderRadius: RADIUS.lg,
    padding: SPACING.lg,
  ...
  grafikTitle: { fontSize: TYPOGRAPHY.size.md, fontFamily: 'PlusJakartaSans_700Bold', color: '#000000', marginBottom: SPACING.md },
  ...
  barLabel: { fontSize: TYPOGRAPHY.size.xs, color: COLORS.text.tertiary, fontFamily: 'PlusJakartaSans_500Medium'},
  barLabelToday: { color: '#000000', fontFamily: 'PlusJakartaSans_700Bold'},
  ...
  modalTitle: { fontSize: TYPOGRAPHY.size.xl, fontFamily: 'PlusJakartaSans_800ExtraBold', color: '#000000', marginBottom: SPACING.xs },
  ...
  mealTypeBtnText: { fontSize: TYPOGRAPHY.size.sm, fontFamily: 'PlusJakartaSans_600SemiBold', color: COLORS.text.secondary },
  ...
  calorieInput: {
    fontSize: 48, fontFamily: 'PlusJakartaSans_800ExtraBold', color: '#000000',
    textAlign: 'center', minWidth: 120,
  },
  calorieInputUnit: { fontSize: TYPOGRAPHY.size['2xl'], color: COLORS.text.tertiary, fontFamily: 'PlusJakartaSans_600SemiBold'},
  mealNoteInput: {
  ...
  modalSaveBtnText: { fontSize: TYPOGRAPHY.size.lg, fontFamily: 'PlusJakartaSans_700Bold', color: '#000000' },
  // Empty
  emptyState: { alignItems: 'center', paddingVertical: SPACING['3xl'], paddingHorizontal: SPACING['2xl'] },
  emptyTitle: { fontSize: TYPOGRAPHY.size.lg, fontFamily: 'PlusJakartaSans_700Bold', color: '#000000', marginBottom: SPACING.xs, textAlign: 'center' },
